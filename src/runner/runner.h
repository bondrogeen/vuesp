...
#define POOL_64_COUNT 8
#define POOL_64_SIZE 64
#define POOL_128_COUNT 4
#define POOL_128_SIZE 128
#define POOL_256_COUNT 2
#define POOL_256_SIZE 256
#define POOL_512_COUNT 1
#define POOL_512_SIZE 512

#define TOTAL_SLOTS (POOL_64_COUNT + POOL_128_COUNT + POOL_256_COUNT + POOL_512_COUNT)
...
class ScriptRunner {
 ...
 private:
  ...
  uint8_t _slotPoolType[TOTAL_SLOTS];
  ScriptContext _ctx;
  ...
  int findFreeSlot(uint16_t scriptLen) const;
  void initSlotPools();
