...
Port ports[6] = {
    ...
    {KEY_PORT, 5, 0, GPIO_MODE_OUTPUT, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC_AND_ADC, GPIO_DISABLED_OFF},
    {KEY_PORT, 12, 0, GPIO_MODE_OUTPUT, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC_AND_ADC, GPIO_DISABLED_OFF},
    {KEY_PORT, 13, 150, GPIO_MODE_PWM, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC_AND_ADC, GPIO_DISABLED_OFF},
    {KEY_PORT, 14, 0, GPIO_MODE_OUTPUT, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC_AND_ADC, GPIO_DISABLED_OFF},
