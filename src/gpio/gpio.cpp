...
Port ports[5] = {
    // {KEY_PORT, 0, 0, GPIO_MODE_PWM, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC, GPIO_DISABLED_ON},
    // {KEY_PORT, 1, 0, GPIO_MODE_PWM, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC, GPIO_DISABLED_ON},
    // {KEY_PORT, 2, 0, GPIO_MODE_PWM, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC, GPIO_DISABLED_ON},
    {KEY_PORT, 7, 0, GPIO_MODE_ONEWIRE, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC, GPIO_DISABLED_ON},
    {KEY_PORT, 5, 0, GPIO_MODE_DEF_INPUT, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC, GPIO_DISABLED_ON},
    {KEY_PORT, 6, 0, GPIO_MODE_DEF_INPUT, GPIO_INTERRUPT_OFF, GPIO_BIT_ALL_NOT_DAC, GPIO_DISABLED_ON},
};
#elif defined(ESP32)
Port ports[10] = {
