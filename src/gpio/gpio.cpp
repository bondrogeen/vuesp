...
Port ports[8] = {
    ...
    {KEY_PORT, GPIO_INT, 0, GPIO_MODE_INPUT_PULLUP, GPIO_INTERRUPT_CHANGE, GPIO_BIT_INPUT, GPIO_DISABLED_ON},
    {KEY_PORT, GPIO_DAC1, 0, GPIO_MODE_DAC, GPIO_INTERRUPT_OFF, GPIO_BIT_DAC, GPIO_DISABLED_ON},
    {KEY_PORT, GPIO_DAC2, 0, GPIO_MODE_DAC, GPIO_INTERRUPT_OFF, GPIO_BIT_DAC, GPIO_DISABLED_ON},
    {KEY_PORT, GPIO_ADC1, 0, GPIO_MODE_ADC, GPIO_INTERRUPT_OFF, GPIO_BIT_ADC, GPIO_DISABLED_ON},
    {KEY_PORT, GPIO_ADC2, 0, GPIO_MODE_ADC, GPIO_INTERRUPT_OFF, GPIO_BIT_ADC, GPIO_DISABLED_ON},
    {KEY_PORT, GPIO_ADC3, 0, GPIO_MODE_ADC, GPIO_INTERRUPT_OFF, GPIO_BIT_ADC, GPIO_DISABLED_ON},
    {KEY_PORT, GPIO_ADC4, 0, GPIO_MODE_ADC, GPIO_INTERRUPT_OFF, GPIO_BIT_ADC, GPIO_DISABLED_ON},
};
